...
const state = {
  platform:'windows', song:null, songId:null, audioFile:null, audioBuffer:null,
...
$('#platformBadge').textContent='WINDOWS v5.2.3';
...
function checkIsolationStatus(){if(!state.song){$('#isolationSongHint').textContent='Analyze or open a song first.';return;}$('#isolationSongHint').textContent=`${state.song.title} · processed locally on this Windows PC`;}
